...
Desde la perspectiva de Manovich, la relevancia de este caso no reside únicamente en su escala tecnológica, sino en la forma en que distintos medios pierden su autonomía y se integran bajo una **lógica computacional común**. La arquitectura deja de ser un soporte estático y se convierte en una interfaz dinámica, donde imagen, sonido, espacio y cuerpo del espectador se coordinan a través de sistemas digitales. Cine, concierto, espectáculo y simulación ya no son formatos separados, sino componentes de una misma experiencia programada.

El software actúa aquí como un **metamedio**, capaz de reorganizar lenguajes culturales tradicionales. Las imágenes no se proyectan sobre una pantalla frontal, como en el cine clásico, sino que envuelven completamente al espectador, eliminando el encuadre y reforzando la sensación de inmersión. El sonido, distribuido de forma espacial, y los efectos físicos amplían la experiencia más allá de lo visual, generando una percepción multisensorial difícilmente reproducible fuera de este entorno específico.

Uno de los aspectos más significativos de la Sphere es que el contenido no puede separarse del espacio arquitectónico que lo soporta. No se trata de una película o un concierto que pueda trasladarse a otro formato sin perder su sentido, sino de una experiencia **site-specific**, diseñada para un dispositivo arquitectónico concreto. Este rasgo conecta directamente con la idea de Manovich de que el software no solo reproduce medios anteriores, sino que redefine sus condiciones de existencia.

Desde una perspectiva personal, considero que la Las Vegas Sphere representa un cambio de paradigma en la relación entre arquitectura y medios digitales. El edificio ya no es únicamente un espacio físico, sino un sistema audiovisual programable, actualizable y mutable, similar a una plataforma de software. Este enfoque encaja plenamente con la visión de Manovich sobre la cultura digital contemporánea, donde el software se convierte en el elemento central que articula nuevas formas de experiencia cultural.
...
Desde mi punto de vista, uno de los aspectos más interesantes de este caso es el uso de una interfaz familiar —la televisión— para introducir una lógica claramente digital. El gesto cotidiano del zapping se convierte en una forma de navegación propia del software, donde el contenido se comporta como una base de datos sincronizada. El resultado no es simplemente un videoclip interactivo, sino un medio híbrido que ejemplifica cómo el software reconfigura prácticas culturales existentes, tal como describe Manovich.

---

## Uso de la inteligencia artificial

En el desarrollo de esta práctica se ha hecho un uso limitado de herramientas de inteligencia artificial como apoyo en la organización de ideas, la revisión sintáctica y la clarificación conceptual del término “hibridación” según Lev Manovich. El contenido final del ensayo responde a una reflexión personal y a un análisis crítico propio de los casos estudiados, sin delegar la redacción completa ni la argumentación en sistemas de generación automática de texto.
